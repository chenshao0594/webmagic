...
public class HttpUriRequestConverterTest {
    ...
    public void test_illegal_uri_correct() throws Exception {
        ...
        HttpClientRequestContext requestContext = httpUriRequestConverter.convert(new Request(UrlUtils.fixIllegalCharacterInUrl("http://bj.zhongkao.com/beikao/yimo/##")), Site.getInstance(), null);
